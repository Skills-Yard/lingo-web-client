  ...
  return (
    <div className="flex flex-col gap-5 min-[996px]:grid min-[996px]:grid-cols-5 min-[996px]:gap-x-8 min-[996px]:items-center min-[996px]:min-h-full min-[996px]:content-center">
      ...
      <div className="flex min-w-0 flex-col gap-3 min-[996px]:col-span-3 min-[996px]:col-start-2 min-[996px]:row-span-2 min-[996px]:row-start-1">
        ...
        <div className="relative w-full aspect-video max-h-100 min-[996px]:aspect-auto min-[996px]:max-h-none min-[996px]:h-105 overflow-hidden rounded-[8px] bg-[#1A1C22] shadow-lg">
          <video
            src="/vedio/lumi.mp4"
            controls
            preload="metadata"
