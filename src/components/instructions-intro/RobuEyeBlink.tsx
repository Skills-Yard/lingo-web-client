...
// the eyes' own happy/sad trios below, just driven by "is Robu currently
// talking" instead of a fixed interval.
 ...
 * listeners/timers-only cleanup shape `useTalkingMouth` already uses above.
 */
