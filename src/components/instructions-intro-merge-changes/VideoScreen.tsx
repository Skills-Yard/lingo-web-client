...
export function VideoScreen({
  ...
  return (
    ...
    >
      {/* Robu + his "What are Instructions?" line — plain typed text, no
          bubble chrome (border/background/tail), paired with him as one
          grid item spanning the same col2-4/row1 area a boxed bubble
          would've used, so the rows below don't shift. */}
      <div className="flex flex-row items-center justify-center gap-2 sm:gap-3 min-[996px]:col-start-2 min-[996px]:col-span-3 min-[996px]:row-start-1 min-[996px]:gap-5">
        <RobuAnchor
      ...
      <div
        ...
        // height too (Robu above), even though it only ever sits next to
        // the video. Placed in just row 2 with `self-stretch`,
