        ...
        <>
          ...
          {slide.actionButtons?.map((button) => (
            <button
              ...
              className="h-[63px] w-full max-w-[280px] md:h-[72px] md:max-w-[320px] md:px-5 rounded-[6px] text-base md:text-2xl font-semibold text-[#2C2C2C] shadow-[1px_1px_16px_3px_rgba(0,0,0,0.29)] transition-all hover:opacity-90 active:scale-95 [background:linear-gradient(90deg,#59EBCE_0%,#CCF772_100%)]"
            >
              {button.label}
            </button>
          ))}
