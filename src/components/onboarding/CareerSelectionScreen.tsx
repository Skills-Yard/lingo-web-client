...
const CAREERS = [
  { id: "se", label: "Software Engineer", icon: "placeholder-se" },
  { id: "ds", label: "Data Scientist", icon: "placeholder-ds" },
  { id: "da", label: "Data Analyst", icon: "placeholder-da" },
  { id: "devops", label: "DevOps / Cloud Engineer", icon: "placeholder-devops" },
  { id: "cyber", label: "Cybersecurity", icon: "placeholder-cyber" },
  { id: "auto", label: "Automation & Scripting", icon: "placeholder-auto" },
];

export function CareerSelectionScreen({ onNext, onBack }: { onNext?: () => void; onBack?: () => void }) {
          ...
          {CAREERS.map((career) => {
            ...
            return (
              ...
              >
                ...
                <span className="font-medium text-base">{career.label}</span>
              </button>
            );
          })}
        </div>
