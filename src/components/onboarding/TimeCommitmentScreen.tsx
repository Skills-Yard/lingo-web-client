...
const TIME_OPTIONS = [
  { id: "15min", label: "15 min a day", icon: "placeholder-15m" },
  { id: "30min", label: "30 min a day", icon: "placeholder-30m" },
  { id: "45min", label: "45 min a day", icon: "placeholder-45m" },
  { id: "1hour", label: "1 hour a day", icon: "placeholder-1h" },
];

export function TimeCommitmentScreen({ onNext, onBack, careerTitle = "Software Engineering" }: { onNext?: () => void; onBack?: () => void; careerTitle?: string }) {
    ...
    <div className="flex flex-col min-h-screen bg-white dark:bg-[#0D1016] text-[#2C2C2C] dark:text-white font-sans max-w-md mx-auto relative">
      ...
      <header className="flex items-center justify-between px-4 pt-6 mb-6 shrink-0">
        ...
        <div className="flex flex-col items-center">
          <span className="text-xs font-bold text-[#01A17F] mb-1">06/07</span>
      ...
      <div className="flex-1 flex flex-col gap-8 px-4 pb-6">
        <div className="flex items-start gap-4 px-2">
          ...
          <h1 className="text-xl font-semibold leading-snug">
            How much time can you give <span className="text-[#01A17F]">{careerTitle}</span> each day?
          </h1>
        </div>
